...
public class ReportePdfService implements ReporteService {
    ...
    public ReportePdfService(CancionRepository cancionRepository, ListaRepository listaRepository, UsuarioCancionRepository usuarioCancionRepository, UsuarioRepository usuarioRepository) {
